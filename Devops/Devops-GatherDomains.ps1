...
$result = "E:\disenza\scripts\out\Domains\"
$fullListLocation = "E:\disenza\scripts\out\Domains\$dt.txt"
                        ...
                        if(($strSite -notmatch 'ETDsoya.com') -and ($strSite -ne '') ){ #-and ($strSite -notmatch 'disenzaone.com')){ ## >>>>>
                            ...
                            if(($ClientShortName -eq "OD") -OR ($ClientShortName -eq "NOTINUSE") -OR ($ClientShortName -eq "NOTLIVE")){
                              ...
                              $OutputFileName = $ClientShortName+"`_"+$Domain
                               if(($ClientShortName -ne "SITE") -AND ($ClientShortName -ne "MAINTENENACE")){
...
EmailMe -subject "Finished Gathering Domains :: SSPAGE" -body "This job is on 
