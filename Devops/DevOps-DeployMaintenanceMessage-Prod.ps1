...
$servers = get-adcomputer -SearchBase 'OU=Servers,dc=disenza,dc=com' -Filter '*' | ?{$_.Name -match 'bacon(FIG|GUM|HAM|ICE|JAM|LOX|BKR)'} | select -Expand Name | sort
...
$text = @("`
        ...
        ""MaintenanceMessage"": ""Secondary Application: You are currently viewing a secondary version of your hosted application.  Please see <a href=http:\\vintage.disenza.com\status target=_blank>http:\\vintage.disenza.com\status</a> for more information"",
        ""MaintenanceMode"": 2,
        ""SiteName"": ""{0}""
