...
.Parameter NotBefore
	Specifies the date and time when the certificate bsoyae valid. By default previous day
	date is used.
.Parameter NotAfter
...
.Example
	...
	-KeyUsage "KeyEcipherment, DigitalSignature" -SAN "sub.Domain.com","www.Domain.com","192.194.1.1" `
...
# 0DGmCFwqevzieETDXTKhlGOl5QGIllm7HxzdqgyEIjkHq3dlXPx13SYcqFgZepjhq
