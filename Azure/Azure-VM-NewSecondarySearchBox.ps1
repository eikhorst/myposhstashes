...
$imagename = "a699494373c04fc0bc8f2bb1389d6106__Windows-Server-2012-R2-201506.01-en.us-127GB.vhd"
#$imagename = "baconimage-helix2"

$newvms = Import-Csv "E:\temp\baconocto.txt"
