...
$ou = 'OU=Sql,OU=Servers,DC=disenza,DC=com'
...
$imagename = "fb83b3509582419d99629ce476bcb5c8__SQL-Server-2008R2SP2-GDR-10.50.4021.0-Web-ENU-Win2K8R2-CY14SU02"
...
$vm1 = New-AzureVMConfig -Name $m.machinename -InstanceSize $m.instanceSize -ImageName $imagename |
    ...
    $vm1 | Add-AzureDataDisk -CreateNew -DiskSizeInGB 250 -DiskLabel 'Scratch' -LUN 0
    $vm1 | Add-AzureDataDisk -CreateNew -DiskSizeInGB 250 -DiskLabel 'Scratch' -LUN 1
...
#Set-AzureVMExtension -Publisher Microsoft.Azure.Security -ExtensionName IaaSAntimalware -PublicConfiguration $AntimalwareConfigFile -VM $vm1
