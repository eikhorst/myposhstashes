...
$serviceName = 'bald-primtcity'

# Retreive with Get-AzureStorageAccount
$storageAccountName = 'bdsatu2lrs'
...
$imagename = 'a699494373c04fc0bc8f2bb1389d6106__Windows-Server-2012-R2-201505.01-en.us-127GB.vhd' #$images[49].ImageName  # Windows Server 2012 a699494373c04fc0bc8f2bb1389d6106__Windows-Server-2012-R2-201404.01-en.us-127GB.vhd
...
$newvms = Import-Csv "C:\oni\scripts\VM\newvms2.txt"
