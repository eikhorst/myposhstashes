...
$authuser = "disenza\da-firep"
$authpass = cat c:\temp\dtss.txt | ConvertTo-SecureString
$credential = New-Object -TypeName System.Management.Automation.PSCredential -ArgumentList $authuser, $authpass
...
$newvms = Import-Csv "C:\git\repos\azure\vmcreation\sqlsentry.txt"
