...
{     
    ...
    write-host "Processing $($objDistributionGroup.PrimarySMTPAddress)..." 
 
    $failedmessages = Get-MessageTrace -StartDate $dateStart -EndDate $dateEnd -RecipientAddress $objDistributionGroup.PrimarySmtpAddress | ?{$_.Status -eq "Failed"} 
